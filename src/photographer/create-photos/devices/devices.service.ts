/**
 * @description The key is used to retrieve the device example:  puppeteer.devices[key]
 */
export type ChosenDevice = { key: string; fileName: string };
const I_PAD_PRO_11 = {
  key: 'iPad Pro 11',
...
export class DevicesService {
  devices: ChosenDevice[] = [
    ...
    I_PHONE_13_MINI,
    I_PHONE_13_PRO_MAX,
    I_PHONE_13_LANDSCAPE,
    I_PHONE_SE_LANDSCAPE,
    I_PHONE_13_MINI_LANDSCAPE,
    I_PHONE_13_PRO_MAX_LANDSCAPE,
    I_PAD_GEN_7_LANDSCAPE,
